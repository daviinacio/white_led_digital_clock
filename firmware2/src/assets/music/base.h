...
#define WHOLE_NOTE_TIMING_TICKS 64


// Metadata
#define MUSIC_END 0

#define MUSIC_MIN_VALUE 1
#define MUSIC_MAX_VALUE 20

#define MUSIC_BPM 21
#define MUSIC_BEATS 22
...
#define WHOLE_NOTE_SLUR                WHOLE_NOTE, SLUR
#define HALF_NOTE_SLUR                 HALF_NOTE, SLUR
#define QUARTER_NOTE_SLUR              QUARTER_NOTE, SLUR
#define EIGHTH_NOTE_SLUR               EIGHTH_NOTE, SLUR
#define SIXTEENTH_NOTE_SLUR            SIXTEENTH_NOTE, SLUR
#define THIRTY_SECOND_NOTE_SLUR        THIRTY_SECOND_NOTE, SLUR
#define SIXTY_FOURTH_NOTE_SLUR         SIXTY_FOURTH_NOTE, SLUR

#define WHOLE_NOTE_DOTTED_SLUR         WHOLE_NOTE_DOTTED, SLUR
#define HALF_NOTE_DOTTED_SLUR          HALF_NOTE_DOTTED, SLUR
#define QUARTER_NOTE_DOTTED_SLUR       QUARTER_NOTE_DOTTED, SLUR
#define EIGHTH_NOTE_DOTTED_SLUR        EIGHTH_NOTE_DOTTED, SLUR
#define SIXTEENTH_NOTE_DOTTED_SLUR     SIXTEENTH_NOTE_DOTTED, SLUR
#define THIRTY_SECOND_NOTE_DOTTED_SLUR THIRTY_SECOND_NOTE_DOTTED, SLUR
#define SIXTY_FOURTH_NOTE_DOTTED_SLUR  SIXTY_FOURTH_NOTE_DOTTED, SLUR
